...
qk_tap_dance_action_t tap_dance_actions[] = {
  ...
  [TD_CAPS_L1] = ACTION_TAP_DANCE_LAYER_TOGGLE(KC_CAPS, _L1),
};

#define KC_CAPL1 TD(TD_CAPS_L1)
...
//      Ct_L     Win_L    Alt_L                               SPACE                               Alt_R    FN       Ct_R     Left     Down     Right
    ...
    [0] = LAYOUT(
        ...
        KC_CAPL1, KC_A,   KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT,           KC_ENT,          KC_PGDN,
