...
//      Ct_L     Win_L    Alt_L                               SPACE                               Alt_R    FN       Ct_R     Left     Down     Right
    ...
    [1] = LAYOUT(
        RGB_TOG, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,          KC_MUTE,
        ...
        _______, TT(2), _______,                            _______,                            _______, TO(0), _______, RGB_VAD, RGB_RMOD, RGB_VAI
    ),
